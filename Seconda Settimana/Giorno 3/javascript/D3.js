...
for(let j = 0;j<starWarsCharacters.length;j++){
  if (starWarsCharacters[j].gender === "female"){
    femaleCharacters.push(starWarsCharacters[j].gender)
  }
}
...
for(let k = 0; k < starWarsCharacters.length;k++){
  switch(starWarsCharacters[k].eye_color){
      case "blue": 
      eyeColor["blue"].push(starWarsCharacters[k]);
      break;
      case "yellow":
      eyeColor["yellow"].push(starWarsCharacters[k])
      break;
      case "brown":
      eyeColor["brown"].push(starWarsCharacters[k])
      break;
      case "red":
      eyeColor["red"].push(starWarsCharacters[k])
      break;
      case "blue-gray":
      eyeColor["blue-gray"].push(starWarsCharacters[k])
      break;
        }
      }
...
while(m < starWarsCharacters.length){
 ...
 console.log("Massa dell'equipaggio " + crewMass)
/* ESERCIZIO 7
...
*/
for(let k = 0; k < starWarsCharacters.length;k++){
  if (starWarsCharacters[k].gender === "n/a"){
    (starWarsCharacters[k].gender = "robot")
  }
}
